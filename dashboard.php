    ...
    ***********************************-->
    <div id="main-wrapper">
		...
		<div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">Reader.</h2>
					<span class="brand-sub-title">Library Management System</span>
				</div>
            </a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li><a href="index-2.html" class="" aria-expanded="false">
					...
					<li><a href="widget-basic.html" class="" aria-expanded="false">
						...
						<span class="nav-text">ISSUE BOOKS</span>
					</a>
				</li>
				...
				<ul aria-expanded="false">
					<li><a href="page-lock-screen.html">ADD NEW BOOK</a></li>
					<li><a href="empty-page.html">BOOK LIST</a></li>
				</ul>
			</li>
                    <li><a href="widget-basic.html" class="" aria-expanded="false">
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<div class="side-bar-profile-img">
							<img src="https://avatars.dicebear.com/api/adventurer/afcswwqXVBBdeelaka.svg" alt="">
						</div>
						<div class="profile-info1">
							<h4 class="fs-18 font-w500">DEELAKA LAKPURA</h4>
							<span>ds.studios02@gmail.com</span>
						</div>
					...
					<div class="d-flex justify-content-between mb-2 progress-info">
						<span class="fs-12"><i class="fas fa-star text-orange me-2"></i>Profile Progress</span>
										...
										<div class="card tryal-gradient">
											<div class="card-body tryal row">
												<div class="col-xl-7 col-sm-6">
													<h2>Manage your library in one touch</h2>
													<span>Let Reader manage your library automatically with our best system. </span>
													<a href="javascript:void(0);" class="btn btn-rounded  fs-18 font-w500">Add New Book</a>
												</div>
												<div class="col-xl-5 col-sm-3">
													<img src="https://i.ibb.co/sjQ1SJ3/6607-ai.png" alt="" class="sd-shape">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body px-4 pb-0">
														<h4 class="fs-18 font-w600 mb-5 text-nowrap">Total User</h4>
														<div class="progress default-progress">
											...
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body d-flex px-4  justify-content-between">
														<div>
															<div class="">
																<h2 class="fs-32 font-w700">62</h2>
																<span class="fs-18 font-w500 d-block">Suppliers</span>
											...
											<div class="col-xl-6 col-xxl-12 col-sm-6">
												<div class="card">
													<div class="card-header border-0">
														<div>
															<h4 class="fs-20 font-w700">Book Categories</h4>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">DexignLab </a>2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
